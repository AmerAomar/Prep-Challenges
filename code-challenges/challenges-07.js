...
const objLat = (obj) => {
    let a = obj.firstName.charAt(0).toUpperCase() + obj.firstName.slice(1);
    let b = obj.lastName.charAt(0).toUpperCase() + obj.lastName.slice(1)
    return `my name is ${a} ${b} I am ${obj.age} YO, and I love ${obj.hobby}.`;
};
// -------------------------------------------------------------------------------------------------------
